...
DATASET = 'EdgeIoT_250_rows.csv' # DATASET EDGE 
# DATASET = 'TON_350_rows.csv' # DATASET TON
...
model = GPTNeoForSequenceClassification.from_pretrained(MODEL_NAME, num_labels= num_classes).to(DEVICE)
